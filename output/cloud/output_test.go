...
import (
	...
	"github.com/gesemaya/k6/cloudapi"
	...
	cloudv2 "github.com/gesemaya/k6/output/cloud/expv2"
	cloudv1 "github.com/gesemaya/k6/output/cloud/v1"
...
func TestNewOutputNameResolution(t *testing.T) {
	...
	cases := []struct {
		...
		{
			url: &url.URL{
				Opaque: "github.com/gesemaya/k6/samples/http_get.js",
			},
			expected: "http_get.js",
		},
		{
			url:      mustParse("http://github.com/gesemaya/k6/samples/http_get.js"),
			expected: "http_get.js",
		},
		{
